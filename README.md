...
| 字段         | 类型     | 说明     | 示例值                      |
|------------|--------|--------|--------------------------|
| `time`     | Long   | 主程序时间戳 | `1781440657491`          |
| `version`  | String | 主程序版本号 | `"v2026-06-11 23:05:52"` |
| `platform` | String | 操作系统平台 | `"Windows"`              |
| `list`     | Array  | 当前账号列表 | `[1000000, 3889527093]`  |
